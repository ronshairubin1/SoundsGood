...
import json
from datetime import datetime  # Changed from "import datetime" to import the datetime class directly
...
class CNNModel(BaseModel):
    ...
    def save(self, filename=None, **kwargs):
        ...
        try:
            ...
            # Save the model with the Keras API
            ...
            try:
                ...
                # Log the metadata error but don't fail the entire save operation
                logging.error(f"Error saving model metadata: {metadata_error}")
                logging.info("Model was saved successfully, but metadata could not be saved.")
