...
from backend.src.services.inference_service import InferenceService
...
class MlApi:
    ...
    def _register_routes(self):
        ...
        def start_listening_api():
            ...
            # Forward to the blueprint function
            from backend.src.routes.ml_routes import start_listening
        ...
        def stop_listening_api():
            ...
            # Forward to the blueprint function
            from backend.src.routes.ml_routes import stop_listening
        ...
        def prediction_stream_api():
            ...
            # Forward to the blueprint function
            from backend.src.routes.ml_routes import prediction_stream
        ...
        def inference_statistics_api():
            ...
            # Forward to the blueprint function
            from backend.src.routes.ml_routes import inference_statistics
        ...
        def record_feedback_api():
            ...
            # Forward to the blueprint function
            from backend.src.routes.ml_routes import record_feedback
        ...
        def save_analysis_api():
            ...
            # Forward to the blueprint function
            from backend.src.routes.ml_routes import save_analysis
    ...
    def handle_list_models(self):
        ...
        try:
            ...
            models_json_path = os.path.join(base_dir, 'models', 'models.json')
            ...
            # Include all models
            filtered_models = []
            for model_type, models_list in transformed_models.items():
                if models_list:
                    filtered_models.extend(models_list)
