...
@user_bp.route('/auto-login', methods=['GET'])
def auto_login():
    """Special route to automatically log in with test credentials.
    This is useful for development and testing environments.
    """
    # Use our test account credentials
    result = user_service.login('test', 'test')
